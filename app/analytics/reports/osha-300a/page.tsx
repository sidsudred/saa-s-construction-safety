...
import { OSHA300ASummary } from "@/components/analytics/osha-300a-summary"
                ...
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="font-bold text-lg hidden sm:block">
                            OSHA Form 300A Summary Viewer <span className="text-muted-foreground font-normal ml-2">({year})</span>
                        </h1>
                    </div>
...
export default function OSHA300APage() {
    return (
        <Suspense fallback={
